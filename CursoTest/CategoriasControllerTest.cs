...
using Moq;// Cria objeto de moq e não objeto real 
using System;
...
namespace CursoTest
{
    ...
    {
        private readonly Mock<DbSet<Categoria>> _mockSet;// Cria objeto de moq e não objeto real 
        private readonly Mock<Context> _mockContext;// Cria objeto de moq e não objeto real 
        private readonly Categoria _categoria;// Cria objeto de moq e não objeto real 
